...
%controllare
\subsection{Caratteristiche del versante emiliano-romagnolo}
...
\subsubsection{C\`a Vecchia pineta San Vitale e gli hotspot per il birdwatching}
...
\subsubsection{La Pineta di Classe}
...
\end{figure}
\subsubsection{Il Bosco della Mesola}
...
\end{figure}
\subsubsection{Le Valli di Comacchio e le saline}
...
\subsubsection{I lidi della costa emiliano-romagnola}
